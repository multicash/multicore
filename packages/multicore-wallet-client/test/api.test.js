...
var CWC = require('multicrypto-wallet-core');
...
var BWS = require('multicore-wallet-service');
  ...
  describe('Build & sign txs', () => {
    ...
    describe('#buildTx', () => {
      ...
      it('should build a tx correctly (BIP44)', () => {
        ...
        var multicoreError = t.getSerializationError({
          disableIsFullySigned: true,
          disableSmallFees: true,
          disableLargeFees: true
        });

        should.not.exist(multicoreError);
    ...
    describe('#pushSignatures', () => {
      it('should sign BIP45 P2SH correctly', () => {
        ...
        // This is a GOOD test, since multicore ONLY accept VALID signatures
