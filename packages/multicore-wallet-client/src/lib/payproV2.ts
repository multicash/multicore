...
const Bitcore = require('multicrypto-wallet-core').BitcoreLib;
const _ = require('lodash');
const sha256 = Bitcore.crypto.Hash.sha256;
const BN = Bitcore.crypto.BN;
var Bitcore_ = {
  btc: Bitcore,
  bch: require('multicrypto-wallet-core').BitcoreLibCash,
  mcx: require('multicrypto-wallet-core').BitcoreLibMcx
};
var MAX_FEE_PER_KB = {
