...
var HDPrivateKey = multicore.HDPrivateKey;
var HDPublicKey = multicore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = multicore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(multicore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(multicore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      multicore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = multicore.PublicKey.fromPoint;
      multicore.PublicKey.fromPoint = function() {
        multicore.PublicKey.fromPoint = unstubbed;
