...
[![NPM Package](https://img.shields.io/npm/v/multicore-p2p-cash.svg?style=flat-square)](https://www.npmjs.org/package/multicore-p2p-cash)

**The peer-to-peer networking protocol for BCH.**

`multicore-p2p-cash` adds Bitcoin Cash protocol support for Bitcore.
...
```sh
npm install multicore-p2p-cash
```
...
```javascript
var Peer = require('multicore-p2p-cash').Peer;
