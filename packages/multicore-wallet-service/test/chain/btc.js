...
const { BitcoreLib } = require ('multicrypto-wallet-core');
...
describe('Chain BTC', function() {
  ...
  describe('#getBitcoreTx', function() {
    it('should create a valid multicore TX', function() {
    ...
    it('should create a valid signed multicore TX', function() {
    ...
    it('should create a valid unsigned multicore TX', function() {
      var txp = TxProposal.fromObj(signedTxp);
