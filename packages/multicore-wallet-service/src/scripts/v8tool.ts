...
const Bitcore = require('multicore-lib');
...
const BASE = {
  BTC: `https://api.multicash.dev/api/${coin}/${network}`,
  BCH: `https://api.multicash.dev/api/${coin}/${network}`,
  ETH: `https://api-eth.multicore.io/api/${coin}/${network}`,
  XRP: `https://api-xrp.multicore.io/api/${coin}/${network}`
};
