...
import { Web3 } from 'multicrypto-wallet-core';
...
export class EthChain implements IChain {
   ...
   * @param {Object} multicoreBalance - { unconfirmed, confirmed, balance }
   * @param {Number} locked - Sum of txp.amount
   * @returns {Object} balance - Total amount & locked amount.
   */
  private convertBitcoreBalance(multicoreBalance, locked) {
    const { unconfirmed, confirmed, balance } = multicoreBalance;
