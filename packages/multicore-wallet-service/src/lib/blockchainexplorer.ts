...
const PROVIDERS = {
  v8: {
    ...
    eth: {
      livenet: 'https://api-eth.multicore.io',
      testnet: 'https://api-eth.multicore.io'
    },
    xrp: {
      livenet: 'https://api-xrp.multicore.io',
      testnet: 'https://api-xrp.multicore.io'
    },
    mcx: {
      livenet: 'http://api.multicash.io',
      test: 'http://api.multicash.io'
    }
  }
};
