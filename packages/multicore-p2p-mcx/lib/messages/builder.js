...
function builder(options) {
  ...
  if (!options.network) {
    options.network = multicore.Networks.defaultNetwork;
  }

  options.Block = options.Block || multicore.Block;
  options.BlockHeader = options.BlockHeader || multicore.BlockHeader;
  options.Transaction = options.Transaction || multicore.Transaction;
  options.MerkleBlock = options.MerkleBlock || multicore.MerkleBlock;
