...
**To test wallet api routes change allowUnauthenticatedCalls: true inside multicore.config.json**
...
Inside the project root directory /multicore/ run:

```sh
node packages/multicore-node/build/test/benchmark/wallet-benchmark.js
```
