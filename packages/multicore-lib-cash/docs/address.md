...
The errors are listed in the generated file in the [errors folder](https://github.com/bitpay/multicore/tree/master/packages/multicore-lib-cash/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/bitpay/multicore/blob/master/packages/multicore-lib-cash/lib/errors/spec.js).
